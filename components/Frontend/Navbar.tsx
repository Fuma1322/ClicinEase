    ...
    <header className="fixed top-0 bg-white border-b border-blue-400/30 w-full z-50 ">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2.5 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link href="/login" className="text-sm font-semibold leading-6 text-gray-800">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-200">
              ...
              <div className="py-6">
                <Link
                  href="/login"
                  className="text-sm rounded-md px-6 py-2 font-semibold leading-6 text-gray-50 bg-blue-700"
                >
                  Log in
                </Link>
              </div>
