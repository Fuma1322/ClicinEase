...
export default function MultipleFileUpload({
    ...
    function handleImageRemove(fileIndex:any){
        const updatedFiles = files.filter((file,index)=> index !== filleIndex);
    ...
    return  (
        <div className={className}>
            <div className="flex justify-between items-center mb-4">
                ...
                {files && (
                    <button onClick={() => setFiles([])} type="button" className="flex space-x-2 bg-slate-900 rounded-md shadow 
                    ...
                    {files.map((file,i)=> {
                        return(
                            <div key={i} className="relative mb-6">
                                ...
                                <div className="py-2 rounded-md px-6 bg-white dark:text-slate-200 border border-slate-200">
