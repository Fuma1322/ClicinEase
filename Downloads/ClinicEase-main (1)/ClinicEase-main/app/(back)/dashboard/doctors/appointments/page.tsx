    ...
    <div>
         <div className="py-2 px-4 border-b border-gray-200 flex items-center justify-end">
                <div className="flex items-center gap-4">
                    <NewButton title='New Apointment' href="/dashboard/doctor/appointments/new"/>
        </div> 
    </div>
          <DisplayPannel title="Appointment" newAppointmentLink="/dashboard/doctor/appointments/new" count={appointments.length}/>  
    </div>
  )
}
