...
// Page component for displaying patient's appointments
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {appointments.map((item) => (
          ...
          >
            ...
            <div className={cn("flex items-center pt-2 text-blue-600", item.status === "approved" && "text-green-600 font-semibold")}>
              {item.status === "pending" ? (
